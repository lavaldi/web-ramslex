<?php 
	...
	$sql = "UPDATE conf_pago SET `estado` = '1' WHERE idconf_pago =".$idconfirmacion;
	$consulta = mysql_query ($sql, $conexion)
	or die ("Fallo en la consulta");

	$sql1 = "SELECT * FROM conf_pago cp inner join reservas r on cp.idreservas = r.idreservas WHERE idconf_pago =".$idconfirmacion;
	...
	if ($consulta1) {
		$resultado = mysql_fetch_array($consulta1, MYSQL_ASSOC);
